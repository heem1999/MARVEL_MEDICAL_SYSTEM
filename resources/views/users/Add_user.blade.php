                            ...
                            <div class="row mg-b-20">
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    ...
                                    <input class="form-control form-control-sm mg-b-20"
                                        data-parsley-class-handler="#lnWrapper" name="full_name" required=""
                                        type="text">
                                </div>
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                    ...
                                    <select name="branch_id" id="select-beast"
                        ...
                        <div class="row row-sm mg-b-20">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="user_titile" id="select-beast"
                                    class="form-control  nice-select  custom-select">
                                    <option value=""> -- Select clinic rule --</option>
                        ...
                        <div class="row mg-b-20">
                            <div class="col-xs-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('roles_name[]', $roles,[], array('class' =>

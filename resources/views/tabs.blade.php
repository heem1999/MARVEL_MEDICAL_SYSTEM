            ...
            <div class="card" id="basic-alert">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            ...
                                            <p>Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore,
                                                ...
                                                maxime</p>
                                            <p class="mb-0">placeat facere possimus, omnis voluptas assumenda est,
                                                omnis dolor repellendus.</p>
                                        </div>
                                        <div class="tab-pane" id="tab3">
                                            <p>praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias
                                                excepturi sint occaecati cupiditate non provident,</p>
                                            <p class="mb-0">similique sunt in culpa qui officia deserunt mollitia
                        ...
                        <!-- Prism Code -->
                        <figure class="highlight clip-widget" id="tabs">
                            <script type="html-dashlead/script">
                                <div class=" tab-menu-heading">
                            	<div class="tabs-menu1">
                            		<!-- Tabs -->
                            		<ul class="nav panel-tabs main-nav-line">
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <figure class="highlight mb-0" id="element2">
                            <script type="prismsmix/javascript"><div class="panel panel-primary tabs-style-2">
                            	<div class=" tab-menu-heading">
                            		<div class="tabs-menu1">
                            			<!-- Tabs -->
                            			<ul class="nav panel-tabs main-nav-line">
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element2"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                                    ...
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            <li class=""><a href="#tab11" class="active"
                                                    data-toggle="tab"><i class="fa fa-laptop"></i> Tab Style 01</a></li>
                                            <li><a href="#tab12" data-toggle="tab"><i class="fa fa-cube"></i> Tab Style
                                                    02</a></li>
                                            <li><a href="#tab13" data-toggle="tab"><i class="fa fa-cogs"></i> Tab Style
                                                    03</a></li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab14">
                                            ...
                                            <p class="mb-0">Nam libero tempore, cum soluta nobis est eligendi
                                                ...
                                                quibusdam et aut officiis debitis aut rerum necessitatibus </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <figure class="highlight mb-0" id="element3">
                            <script type="prismsmix/javascript"><div class="panel panel-primary tabs-style-3">
                            	<div class="tab-menu-heading">
                            		<div class="tabs-menu ">
                            			<!-- Tabs -->
                            			<ul class="nav panel-tabs">
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element3"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                                            ...
                                            <div class="tabs-menu ">
                                                ...
                                                <ul class="nav panel-tabs ml-3">
                                                    ...
                                                    <li><a href="#tab23" data-toggle="tab"><i class="fa fa-cogs"></i>
                                                            Tab Style 03</a></li>
                                                    <li><a href="#tab24" data-toggle="tab"><i class="fa fa-tasks"></i>
                                                            Tab Style 04</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab23">
                                                <p>Temporibus autem quibusdam et aut officiis debitis aut rerum
                                                    ...
                                                    molestiae non recusandae quod maxime placeat facere possimus, omnis
                                                    voluptas assumenda est, omnis dolor repellendus.</p>
                                                <p>Temporibus autem quibusdam et aut officiis debitis aut rerum
                                                    necessitatibus saepe eveniet ut et voluptates repudiandae sint et
                                                    molestiae non recusandae quod maxime placeat facere possimus, omnis
                                            ...
                                            <div class="tab-pane" id="tab24">
                                                <p>On the other hand, we denounce with righteous indignation and dislike men
                                                    ...
                                                    moment, so blinded by desire quod maxime placeat facere possimus, omnis
                                                    voluptas assumenda est, omnis dolor repellendus.</p>
                                                <p>On the other hand, we denounce with righteous indignation and dislike men
                                                    who are so beguiled and demoralized by the charms of pleasure of the
                                                    moment, so blinded by desire quod maxime placeat facere possimus, omnis
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code4" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ml-1 html-code" id="html-code4" data-toggle="tab"
                                    href="#html-code4" role="tab" aria-controls="html-code4" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                            </li>
                        </ul>
                        ...
                        <figure class="highlight mb-0" id="element4">
                            <script type="prismsmix/javascript"><div class="d-md-flex">
                            	<div class="">
                            		<div class="panel panel-primary tabs-style-4">
                            			<div class="tab-menu-heading">
                            				<div class="tabs-menu ">
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element4"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!---Prism Pre code-->
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="text-wrap">
                    ...
                    <ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active ml-1 html-code" id="js-tab" data-toggle="tab" href="#default-tab"
                                role="tab" aria-controls="default-tab" aria-selected="true"><i
                                    class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                            <a class="nav-link mr-1 html-code" id="js-tab1" data-toggle="tab" href="#default-tab1"
                                role="tab" aria-controls="default-tab1" aria-selected="true"><i
                                    class="fab fa-node-js text-info mr-2"></i>JS</a>
                            <a class="nav-link mr-1 html-code" id="js-tab2" data-toggle="tab" href="#default-tab2"
                                role="tab" aria-controls="default-tab2" aria-selected="true"><i
                                    class="fab fa-node-js text-info mr-2"></i>JS</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="default-tab" role="tabpanel" aria-labelledby="html-tab">
                            ...
                            <figure class="highlight mb-0" id="element5">
                                <script type="prismsmix/javascript"><div class="panel panel-primary">
                                	<div class="tab_wrapper right_tab">
                                		<ul class="tab_list">
                                			<li class="active">Tab 1</li>
                                			<li>Tab 2</li>
                        ...
                        <div class="tab-pane" id="default-tab1" role="tabpanel" aria-labelledby="js-tab">
                            <!---Prism Pre code-->
                            <figure class="highlight mb-0" id="element3">
                                <script type="prismsmix/javascript"><!---Tabs JS-->
                        ...
                        <div class="tab-pane" id="default-tab2" role="tabpanel" aria-labelledby="js-tab1">
                            <!---Prism Pre code-->
                            <figure class="highlight mb-0" id="element4">
                                <script type="prismsmix/javascript"><!---Tabs scripts-->

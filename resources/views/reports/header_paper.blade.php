            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Write Data
                        </h4>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('view_header_paper') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="inputName" class="control-label">Content:</label><br>
                            <textarea name="content" style="border: ridge 2px;
                            padding: 5px;
                            width: 100%;
                            min-height: 5em;
                            overflow: auto;" rows="15">
                            </textarea>
                        </div>
                    </div>
                    <br>

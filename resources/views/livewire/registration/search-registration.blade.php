        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0">Search Registration
                    </h4>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered mg-b-0 text-md-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr style="text-align: center">
                                ...
                                <td>{{ $registration_detail->patient->gender }}</td>
                                <td>{{ $registration_detail->created_at }}</td>
                                <td>
                                    <!-- <a href="registration?acc={{ $registration_detail->acc }}&type=add_service"
                                                target="_blank" data-effect="effect-scale" title="Add Services"><i
                                                    class="fas fa-cart-plus"></i></a> &nbsp;&nbsp;-->

                                    <a href="registration?acc={{ $registration_detail->acc }}&type=cancel_registration"
                                        onclick="var popup =window.open(this.href, 'mywin',
                                            'left=20,top=20,width=900,height=700'); return false; "><i
                                            class="text-danger fas fa-window-close"></i></a>
                                    &nbsp;&nbsp;
                                    <a href="registration?acc={{ $registration_detail->acc }}&type=edit_registration"
                                        onclick="var popup =window.open(this.href, 'mywin',
                                            'left=20,top=20,width=900,height=700'); return false; "><i
                                            class="far fa-address-card"></i></a>
                                    &nbsp;&nbsp;
                                    <a href="registration?acc={{ $registration_detail->acc }}&type=sample_Info" onclick="var popup =window.open(this.href, 'mywin',
                                                    'left=20,top=20,width=900,height=700'); return false; "><i
                                            class="text-warning fas fa-vial"></i></a>
                                </td>
                            </tr>
                            @endforeach

...
@section('title')
    ...
    @if (request()->query('pagename') == 'Receipt_List')
        Receipt List
    @elseif (request()->query('pagename') == 'Delivery_Details')
        Delivery Details
    @elseif (request()->query('pagename') == 'Financial_Claim')
        Financial Claim
    @else
        Search Payment
    @endif
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Financial</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    @if (request()->query('pagename') == 'Receipt_List')
                        <b>Receipt List</b>
                    @elseif (request()->query('pagename') == 'Delivery_Details')
...
@section('content')
    ...
    @livewire('financial.search-payment')

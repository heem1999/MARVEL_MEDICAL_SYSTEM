...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">services</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ services
                    List</span>
            </div>
        </div>
                        ...
                        <table id="example1" class="table table-hover mb-0 text-md-nowrap" data-page-length='50'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Service type</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a data-effect="effect-scale" title="Edit service"
                                                href=" {{ url('edit_service') }}/{{ $service->id }}"><i
                                                    class="text-danger fas fa-edit"></i></a>
                                            &nbsp;&nbsp;
                                            <a title="Delete service" href="#" data-service_id="{{ $service->id }}"

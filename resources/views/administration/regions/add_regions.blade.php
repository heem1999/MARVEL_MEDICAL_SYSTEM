                ...
                <div class="card-body">
                    <form action="{{ route('regions.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href=" {{ url('regions') }}"> <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button></a>
                        </div>
                    </form>
                </div>
            </div>
